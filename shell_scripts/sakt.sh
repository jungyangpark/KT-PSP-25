...
run_single_experiment() {
    ...
    echo "  [SAKT] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_sakt_train.py \
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "SAKT Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting SAKT experiments..."
echo "Mode: $EXP_MODE"
...
echo "SAKT experiments completed!"
