...
# SKVMN specific hyperparameters
DIM_S=200
SIZE_M=50
...
run_single_experiment() {
    ...
    echo "  [SKVMN] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_skvmn_train.py \
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "SKVMN Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting SKVMN experiments..."
echo "Mode: $EXP_MODE"
...
echo "SKVMN experiments completed!"
