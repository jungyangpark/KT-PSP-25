...
# =============================================================================
# StableKT Model Training Script
...
# StableKT specific hyperparameters
D_MODEL=256
D_FF=256
NUM_ATTN_HEADS=8
N_BLOCKS=4
...
run_single_experiment() {
    ...
    echo "  [StableKT] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_stablekt_train.py \
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "StableKT Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting StableKT experiments..."
echo "Mode: $EXP_MODE"
...
echo "StableKT experiments completed!"
