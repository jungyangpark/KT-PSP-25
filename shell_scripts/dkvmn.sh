...
# DKVMN specific hyperparameters
DIM_S=200
SIZE_M=50
...
run_single_experiment() {
    ...
    echo "  [DKVMN] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_dkvmn_train.py \
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "DKVMN Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting DKVMN experiments..."
echo "Mode: $EXP_MODE"
...
echo "DKVMN experiments completed!"
