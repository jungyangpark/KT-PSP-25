...
# =============================================================================
# DKT-Forget Model Training Script
...
# DKT-Forget specific hyperparameters
EMB_SIZE=200
...
run_single_experiment() {
    ...
    echo "  [DKT-Forget] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_dkt_forget_train.py \
...
run_ablation_study() {
    echo "=========================================="
    echo "DKT-Forget Ablation Study"
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "DKT-Forget Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting DKT-Forget experiments..."
echo "Mode: $EXP_MODE"
...
echo "DKT-Forget experiments completed!"
