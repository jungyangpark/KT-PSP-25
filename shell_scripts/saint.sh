...
# SAINT specific hyperparameters
EMB_SIZE=256
NUM_ATTN_HEADS=8
N_BLOCKS=4
...
run_single_experiment() {
    ...
    echo "  [SAINT] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_saint_train.py \
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "SAINT Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting SAINT experiments..."
echo "Mode: $EXP_MODE"
...
echo "SAINT experiments completed!"
