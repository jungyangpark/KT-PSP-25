...
# =============================================================================
# RobustKT Model Training Script
...
# RobustKT specific hyperparameters
D_MODEL=256
D_FF=512
NUM_ATTN_HEADS=8
N_BLOCKS=4
...
run_single_experiment() {
    ...
    echo "  [RobustKT] fold=$fold, lr=$lr, dropout=$dropout, use_mp=$use_mp"

    python wandb_robustkt_train.py \
...
run_hyperparameter_sweep() {
    echo "=========================================="
    echo "RobustKT Hyperparameter Sweep"
    echo "=========================================="
...
echo "Starting RobustKT experiments..."
echo "Mode: $EXP_MODE"
...
echo "RobustKT experiments completed!"
